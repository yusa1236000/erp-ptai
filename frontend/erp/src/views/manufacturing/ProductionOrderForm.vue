            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input 
                  ...
                  :readonly="isEditing"
                  :class="{ 'error': errors.production_number }"
                  placeholder="Will be auto-generated if left empty"
                >
                <div v-if="errors.production_number" class="error-message">
              ...
              <div class="form-group">
                ...
                <input 
                  ...
                  :class="{ 'error': errors.production_date }"
                  required
                >
                <div v-if="errors.production_date" class="error-message">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <select 
                  id="work_order" 
                  v-model="form.wo_id"
                  :class="{ 'error': errors.wo_id }"
                  @change="loadWorkOrderDetails"
                  required
                >
                  <option value="">-- Select Work Order --</option>
                  <option v-for="wo in workOrders" :key="wo.wo_id" :value="wo.wo_id">
                    {{ wo.wo_number }} - {{ wo.product?.name || 'Unknown Product' }}
                  </option>
                </select>
                <div v-if="errors.wo_id" class="error-message">
                  {{ errors.wo_id }}
                </div>
              </div>
            ...
            <div v-if="workOrderDetails" class="info-panel">
              ...
              <div class="info-panel-content">
                <div class="info-row">
                  ...
                  <div class="info-value">{{ workOrderDetails.product?.name || 'N/A' }}</div>
                </div>
                <div class="info-row">
                ...
                <tbody>
                  <tr v-for="(component, index) in form.consumptions" :key="index">
                    ...
                    <td>
                      ...
                      <div v-if="errors[`consumptions.${index}.warehouse_id`]" class="error-message">
                    ...
                    <td>
                      <input 
                        ...
                        required
                      >
                      <div v-if="errors[`consumptions.${index}.planned_quantity`]" class="error-message">
