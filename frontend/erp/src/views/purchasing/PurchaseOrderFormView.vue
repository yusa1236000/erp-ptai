...
<template>
    <div class="po-form-view-container">
  ...
  export default {
    ...
    setup(props) {
      ...
      // Computed filtered vendors to remove nulls with defensive check
      const filteredVendors = computed(() => {
        if (Array.isArray(vendors.value)) {
          return vendors.value.filter(v => v != null);
        }
        return [];
      });
